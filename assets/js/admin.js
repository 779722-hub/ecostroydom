...
function defs(){return{
  ...
  promoDesc:'Забронируйте партию <b>за месяц вперёд</b> и получите скидку 10%. Цена замораживается <b>до отгрузки</b> с момента подписания договора.',
  ...
  blogPosts:[
    ...
    {id:3,title:'Какой клей для газоблока лучше',cat:'Советы',date:'2026-04-02',img:'assets/img/kley-dlya-gazobloka.png',excerpt:'Сравниваем 5 марок клея в Казахстане.',body:'',url:'blog/klej-dlya-gazobloka-obzor.html'},
